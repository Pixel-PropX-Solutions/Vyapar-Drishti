...
// const BASE_URL = 'http://192.168.240.123:8010/api/v1';
const BASE_ADMIN_URL = 'https://dristidocs-backend.onrender.com/api/v1/admin';
// const BASE_ADMIN_URL = 'http://192.168.240.123:8010/api/v1/admin';
...
const MIN_APP_VERSION = '1.0.0.0'

export { BASE_ADMIN_URL, BASE_URL, BASE_WEB_URL, BASE_APP_URL, APP_VERSION, MIN_APP_VERSION };
