...
export const StatsCard = ({ rgb, label, value, valueSize = 14, labelSize = 10 }: { rgb: string, label: string, value: string, valueSize?: number, labelSize?: number }): React.JSX.Element => (
