...
const productDefaultValue: Product = { entry_id: '', item: '', item_id: '', unit: '', hsn_code: '', quantity: 0, rate: 0, amount: 0, discount_amount: 0, tax_rate: 0, tax_amount: 0, total_amount: 0 };
